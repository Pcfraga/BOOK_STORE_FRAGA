...
import com.example.booksfraga.data.AppDatabase
import com.example.booksfraga.viewModel.BookViewModel
import com.example.booksfraga.viewModel.BookViewModelFactory

class MainActivity : ComponentActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContent {
            aplicativobooksfragaApp()
        }
    }
}

@Composable
fun aplicativobooksfragaApp() {
